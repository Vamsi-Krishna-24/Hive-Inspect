...
urlpatterns = [
    ...
    path("<uuid:template_id>/delete/", views.delete_template, name="delete"),
    ...
    path("section/<uuid:section_id>/save/", views.save_section, name="save_section"),
    path("item/<uuid:item_id>/save/", views.save_item, name="save_item"),
]
